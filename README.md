...
| **Backend** | Spring Boot · REST APIs · Auth (JWT) · MySQL · Docker |
| **Frontend** | Angular (v15–19) · HTML · CSS · UI/UX principles |
| **Mobile** | Android (Java) · Room ORM · MVVM · Material Design |
| **DevOps** | Git · GitLab CI/CD · Docker · AWS |
| **Tooling** | IntelliJ IDEA · VS Code · Postman |
